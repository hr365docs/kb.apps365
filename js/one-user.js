$(document).ready(function () {
    ...
    $("#oneuser").append(
        ...
        "<li class='sidelist' data-nav-id='./Introduction/' title='Introduction'>" +
            "<a href='/one-on-one/modern/user/introduction/'>Introduction</a>" +
        "</li>" +

        // ✅ Home Page
        "<li class='sidelist' data-nav-id='./Home/' title='Home Page'>" +
            "<a href='/one-on-one/modern/user/homepage/'>Home Page</a>" +
        "</li>" +

        // ✅ Help
        "<li class='dropdownicon sidelist' title='Help'>" +
            "<a href='/one-on-one/modern/user/help/'>Help</a>" +
        ...
        "<li class='sidelist dropdown_romove_dot'>" +
            "<ul class='sidenavSub-topics aside_dropdown_list'>" +
                "<li class='sidelist' title='Product Activation'>" +
                    "<a href='/one-on-one/modern/user/help/#product'>Product Activation</a>" +
                "</li>" +
            "</ul>" +
        "</li>"
    );
