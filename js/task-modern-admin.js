$(document).ready(function () {
    ...
    $("#taskmodernadmin").append("<ul>" +
        ...
        "</li>" +
        "<li data-nav-id='../advanced/' title='Expense 365' class='sidelist'>" +
        "<a href='/task-management-365/modern/admin/settings/integration/#Expense-Tracker-365'>Expense 365</a>" +
        "</li>" +
