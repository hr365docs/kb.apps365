$(document).ready(function () {
    ...
    $("#orgadmin").append(
        ...
        "<li class='sidelist' data-nav-id='./Settings/' title='Introduction'>" +
            "<a href='/organization-chart-365/modern/admin/introduction/'>Introduction</a>" +
        "</li>" +

        // ✅ Home Page
        "<li class='sidelist' data-nav-id='./Settings/' title='Home Page'>" +
            "<a href='/organization-chart-365/modern/admin/homepage/'>Home Page</a>" +
        "</li>" +

         "<li class='sidelist' data-nav-id='./Settings/' title='Customize Chart'>" +
            "<a href='/organization-chart-365/modern/admin/settings/'>Customize Chart</a>" +
        "</li>" +
        ...
        "<li class='dropdownicon sidelist' title='Help'>" +
            "<a href='/organization-chart-365/modern/admin/help/'>Help</a>" +
        ...
        "<li class='sidelist dropdown_romove_dot'>" +
            "<ul class='sidenavSub-topics aside_dropdown_list'>" +
                "<li class='sidelist' title='Product Activation'>" +
                    "<a href='/organization-chart-365/modern/admin/help/#product'>Product Activation</a>" +
                "</li>" +
            "</ul>" +
        "</li>"
    );
