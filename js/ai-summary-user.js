$(document).ready(function () {
    ...
    $("#aisummaryuser").append(
       
        "<li class='sidelist' data-nav-id='./Introduction/' title='Introduction'>" +
            "<a href='/ai-summary-365/modern/user/introduction/'>Introduction</a>" +
        "</li>" +

     
        "<li class='sidelist' data-nav-id='./HomePage/' title='Home Page'>" +
            "<a href='/ai-summary-365/modern/user/homepage/'>Home Page</a>" +
        "</li>" +

   
        "<li class='dropdownicon sidelist' title='Help'>" +
            "<a href='/ai-summary-365/modern/user/help/'>Help</a>" +
        ...
        "<li class='sidelist dropdown_romove_dot'>" +
            "<ul class='sidenavSub-topics aside_dropdown_list'>" +
                "<li class='sidelist' title='Product Activation'>" +
                    "<a href='/ai-summary-365/modern/user/help/#product'>Product Activation</a>" +
                "</li>" +
            "</ul>" +
        "</li>"
    );
