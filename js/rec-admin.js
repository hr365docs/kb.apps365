...
"<li class='sidelist dropdown_romove_dot'>" +
  "<ul class='sidenavSub-topics aside_dropdown_list'>" +
    ...
    "<li class='sidelist' title='Users'>" +
      "<a href='/recognition-wall-365/modern/admin/settings/#_users'>Users</a>" +
    "</li>" +
    "<li class='sidelist' title='Add Category'>" +
      "<a href='/recognition-wall-365/modern/admin/settings/#_category'>Add Category</a>" +
    "</li>" +
